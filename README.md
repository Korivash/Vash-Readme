...
Vash provides a database that listen to various events and perform actions based on these events. Here are the events Syntax listens to:
...
Vash is equipped with an AI response feature. By mentioning Syntax in your message, like `@Vash`, you can get a response generated by an AI model.
